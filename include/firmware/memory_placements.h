...
#define DATASTORE_START    0x00110000
#define DATASTORE_HEADER_ADDR 0x00110000
#define MAX_FLASH_ADDR     0x0011FFFF
#ifndef CJECA_MAX_MODULES
#define CJECA_MAX_MODULES 1
#endif
#else
#ifndef ECOM_F
#define APPLICATION_START ((void *)0x00020000)
...
#ifdef  RFID
#define KERNEL_VERSION    0x38
#else
#define KERNEL_VERSION    0x30
#endif
#define KERNEL_REVISION   78
#else
...
#define  KERNEL_REVISION   10
#else
#ifdef MCT_UNIVERSAL
#define  KERNEL_VERSION 0x11
#define  KERNEL_REVISION   0
#else
#define  KERNEL_VERSION 0x21
#define  KERNEL_REVISION   0
#endif
#endif
#else
