 ...
 * This file is an example on how to verify an ASCII pin using Part 10
 * of the PC/SC specs.
 * This example uses a STARCOS HBCI card.
 */
...
int main(int argc, char *argv[])
{
	...
	memcpy(bSendBuffer,
	       "\x00\xA4\x04\x0c\x09"
	       "\xd2\x76\x00\x00\x74\x48\x42\x01\x10",
	       send_length);
	...
	pin_verify -> abData[offset++] = 0x90;	/* P2 */
