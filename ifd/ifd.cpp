...
RESPONSECODE IFDHandler::createChannelByName(DWORD Lun, char *devName) {
  ...
  if (strcasecmp(devName, "REINER SCT cyberJack pp_a")==0)
    ...
    wantedPid=0x401;
  else if (strcasecmp(devName, "REINER SCT cyberJack secoder TLS")==0)
    wantedPid=0x412;
  else if (strcasecmp(devName, "REINER SCT cyberJack syonic")==0)
    wantedPid=0x485;
    ...
    wantedPid=0x506;
  else if (strcasecmp(devName, "REINER SCT cyberJack RFID SoliSYSTEMS")==0)
    wantedPid=0x507;
